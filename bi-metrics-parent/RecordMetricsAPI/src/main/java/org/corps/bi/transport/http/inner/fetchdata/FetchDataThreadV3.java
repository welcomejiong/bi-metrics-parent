...
public class FetchDataThreadV3 extends  AbstractFetchDataThread{
	...
	public FetchDataThreadV3(final MetricRocksdbColumnFamilys metricRocksdbColumnFamily,final MetricsTransporterConfig transporterConfig,final AtomicLong processedRecordNum) {
	...
	protected void pollMetrics(){
		try {
			...
			if(isSucc) {
				...
				LOGGER.info("metric:{} isSucc:{} processedId:{} currentMetricId:{} beginKeyId:{}  endKeyId:{} triggerProcessedNum:{} currentProcessSize:{} spendMills:({})",this.metric,isSucc,processedId,currentMetricId,beginKeyId,endKeyId,tmpTriggerProcessedNum,addTimes,(end-begin));
