...
import org.corps.bi.protobuf.common.IntListProto;

import com.google.protobuf.InvalidProtocolBufferException;

public class IntList implements ProtobufSerializable<IntList,IntListProto> {
    ...
    @Override
    public IntList copyFrom(IntListProto intList) {
    ...
    @Override
    public IntList parseFrom(byte[] bytes) {
        try {
        	IntListProto intList = IntListProto.parseFrom(bytes);
            return this.copyFrom(intList);
    ...
    public byte[] toByteArray() {
    	IntListProto intList = (IntListProto) copyTo();
        return intList.toByteArray();
    }
    
    public IntList(byte[] bytes) {
        parseFrom(bytes);
    }
