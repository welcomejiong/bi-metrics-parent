...
public class BytesList implements List<byte[]>, ProtobufSerializable<BytesList,SimpleListProto>{
	...
	@Override
	public BytesList copyFrom(SimpleListProto simpleList) {
	...
	@Override
	public SimpleListProto copyTo() {
		SimpleListProto.Builder builder = SimpleListProto.newBuilder();
	...
	@Override
	public BytesList parseFrom(byte[] bytes) {
		try {
			SimpleListProto simpleList = SimpleListProto.parseFrom(bytes);
			return this.copyFrom(simpleList);
