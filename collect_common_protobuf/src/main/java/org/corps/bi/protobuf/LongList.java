...
import org.corps.bi.protobuf.common.LongListProto;

import com.google.protobuf.InvalidProtocolBufferException;

public class LongList implements ProtobufSerializable<LongList,LongListProto> {
    ...
    @Override
    public LongList copyFrom(LongListProto longList) {
    ...
    @Override
    public LongListProto copyTo() {
    	LongListProto.Builder builder = LongListProto.newBuilder();
        for (int i = 0; i < size; i++) {
    ...
    @Override
    public LongList parseFrom(byte[] bytes) {
        try {
        	LongListProto longList = LongListProto.parseFrom(bytes);
            return this.copyFrom(longList);
